        ...
        <div className="steps">
            <form onSubmit={handleSubmit}>
                <label>
                    ...
                    <input type="text" value={props.stepInput} onChange={e => (props.setStepInput(e.target.value))} placeholder="next step" />
            ...
            <ol>
                {props.steps.map(step => 
                    <div key={step}>
                        ...
                        <button className="delete-button" value={step} onClick={handleDelete}>DELETE</button>
                    </div>
                )}
            </ol>
        </div>
